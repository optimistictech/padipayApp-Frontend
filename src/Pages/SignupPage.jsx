      ...
      <div className="flex justify-around gap-2 small-screen">
        ...
        <div className="bg-white w-screen px-10 m-16 p-8">
          ...
          <form name="loginForm" onsubmit="saveData(event)">
            ...
            <div className="relative my-6">
              <i
                className="fa-solid fa-location-dot absolute px-3.5 py-4 text-2xl"
              ></i>
              <input
                type="text"
                name="address"
            ...
            <div className="flex justify-between">
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm">I accepted all terms & conditions</span>
              </div>
            </div>
          ...
          <p className="font-bold text-xl text-center">
            ...
            <Link to="" className="text-red-500 ml-2">Login</Link> here
          </p>
        </div>
      </div>
      </div>
