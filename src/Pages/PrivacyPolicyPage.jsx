...
const PrivacyPolicyPage = () => {
  ...
  <p className="">
    ...
    Limited (“PadiPay”) that connects verified borrowers to verified lenders
    with the goals of receiving a loan and funding a loan respectively.
    PadiPay will enable borrowers to obtain loans directly from lenders,
    cutting out middlemen and reducing the risk of default. This Privacy
    Policy (together with our Terms of Use) explains what information we
    collect, how we collect, share, use and protect your personal
    information when you visit or use the Application, our website, and
    other services offered by PadiPay. Please read this Policy carefully to
    understand how we collect, use and store your personal data. By
    continuing to use our Application, visit our website, or accessing any
    of our services, you consent to our usage of your personal information
    as described in this Policy. Unless otherwise defined, terms used in
  ...
  <ol>
    ...
    <p className="">
      ...
      covered by the provisions of the laws of Nigeria and other extant laws
      and regulations regarding the use and management of personal data.
    </p>
    ...
    <ul>
      ...
      <p className="">
        ...
        product and you will not need to give this permission if you are not
        using BailMe on the App.Your contact data on our platform is highly
        protected.
      </p>
    </ul>
    <ul>
      ...
      <p className="">
        ...
        your device name, model, region and language settings, device
        identification code, device hardware and software information,
        status, usage habits, unique device identifiers like IMEI and serial
        number to uniquely identify the device and ensure that unauthorized
        devices are not to act on your behalf to prevent frauds. Your device
    ...
    <ul>
      ...
      <p className="">
        ...
        for customer risk assessment and scoring. Your location data on our
        platform is highly protected.
      </p>
    </ul>
    <ul>
      <li className=" font-bold mt-5">Selfie Image</li>
      <p className="">
        We collect your Selfie image through your phone camera but we do not
        access your photos. The selfie image captured on our app is compared
        with photo from your identity card or Bank Verification Number to
        determine that you are same person. Your selfie image data on our
        platform is highly protected.
      </p>
    </ul>
    ...
    <ul>
      <li className=" mt-5">
        ...
        we think may be of interest to you, and changes to the Application
        and Service.
      </li>
    </ul>
    <ul>
    ...
    <p className="">
      ...
      security. PadiPay takes the safeguarding of your personal information
      very seriously. We maintain physical, electronic and procedural
      safeguards that comply with applicable laws and regulations to ensure
      the security of your information, prevention of unauthorized access
      and use, accidental or unlawful alteration and destruction; and other
      unlawful or unauthorized forms of processing.
    </p>
    <p className="">
      We regularly update our security protocols and processes to meet
      industry standards. If you have been provided a password to grant you
      access to the Application or specific areas on our website, you are
      responsible for keeping this password confidential. You must not share
      your password or other authentication details with anyone, PadiPay
      will not be responsible for any losses you may incur if you disclose
      your password and/or authentication details. We will store and retain
      your data for as long as is necessary for the purpose(s) that it was
      collected. Storage of your data is also determined by legal,
      regulatory, administrative or operational requirements.
    </p>
    ...
    <ol>
      ...
      <li className=" mt-5">
        ...
        information by contacting us at support@PadiPay.com. Please allow up
      ...
      <li className=" mt-5">
        ...
        reject all cookies. If you choose to reject all cookies some parts
        of our Application and website may not work properly in your case.
      </li>
      <li className=" mt-5">
    ...
    <p className="">
      ...
      would like to submit a related data privacy right request, please
      email us at
      <strong><em className="text-blue-900">support@PadiPay.com.</em></strong>
      Please allow up to 30 days for requests to be processed. The Company
      reserves the right to charge a reasonable fee to process excessive or
      repeat requests. Contact us if you have any questions about this
