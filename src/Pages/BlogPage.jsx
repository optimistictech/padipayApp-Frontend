    ...
    <Navbar/>
      ...
      <main className="relative">
        ...
        <section className="px-10">
          ...
          <div style={{backgroundImage: `url(${'https://ik.imagekit.io/9tezgt6wp/postForBlog1.png?updatedAt=1700151326496'})`}} className="flex w-[1200px] rounded-[12px]  flex-col justify-end bg-cover lg:h-[450px] lg:mt-10 gap-10 p-[40px] container mx-auto ">
          ...
          <div className="flex  flex-col items-start gap-[20px]">
            <div className="flex items-start gap-[20px]">
              ...
              <div className="flex w-[392px] p-[16px] flex-col justify-center	item-center gap-[16px] rounded-[12px] bg-white border-solid border-[1px] border-[#E8E8EA]">
                <img src={'https://ik.imagekit.io/9tezgt6wp/postForBlog1.png?updatedAt=1700151326496'} className="w-[360px] h-[240pxpx] rounded-[6px]"/>
                <div className="flex p-[8px] flex-col items-start gap-[20px] self-stretch	">
                  <div className="flex flex-col items-start gap-[16px] self-stretch">
                    ...
                    <div className="flex items-center gap-[20px]">
                      <img src={'https://ik.imagekit.io/9tezgt6wp/avater.jpeg?updatedAt=1700152909415'} className="flex items-center gap-[12px] w-[36px] h-[36px] rounded-[28px] bg-lightgray bg-cover bg-no-repeat" />
              ...
              <Link to="/postForBlog">
              <div className="flex w-[392px] p-[16px] flex-col justify-center	item-center gap-[16px] rounded-[12px] bg-white border-solid border-[1px] border-[#E8E8EA]">
                <img src={'https://ik.imagekit.io/9tezgt6wp/money.jpeg?updatedAt=1700153289546'} className="w-[360px] h-[240pxpx] rounded-[6px]" />
                <div className="flex p-[8px] flex-col items-start gap-[20px] self-stretch	">
                  <div className="flex flex-col items-start gap-[16px] self-stretch">
                    <button className="rounded-[16px] text-[#4B6BFB] bg-arbitrary  py-[4px] px-[10px] justify-center items-center gap-[4px] " style={{backgroundColor: 'rgba(75, 107, 251, 0.05)'}}>
                      Business
                    ...
                    <div className="flex items-center gap-[20px]">
                      <img src={'https://ik.imagekit.io/9tezgt6wp/ayo.jpeg?updatedAt=1700152952770'} className="flex items-center gap-[12px] w-[36px] h-[36px] rounded-[28px] bg-lightgray bg-cover bg-no-repeat" />
              ...
              <Link to="/postForBlog">
              <div className="flex w-[392px] p-[16px] flex-col justify-center	item-center gap-[16px] rounded-[12px] bg-white border-solid border-[1px] border-[#E8E8EA]">
                <img src={'https://ik.imagekit.io/9tezgt6wp/book.jpeg?updatedAt=1700153094494'} className="w-[360px] h-[240pxpx] rounded-[6px]" />
                <div className="flex p-[8px] flex-col items-start gap-[20px] self-stretch	">
                  <div className="flex flex-col items-start gap-[16px] self-stretch">
                    <button className="rounded-[16px] text-[#4B6BFB] bg-arbitrary  py-[4px] px-[10px] justify-center items-center gap-[4px] " style={{backgroundColor: 'rgba(75, 107, 251, 0.05)'}}>
                      Business
                    ...
                    <div className="flex items-center gap-[20px]">
                      <img src={'https://ik.imagekit.io/9tezgt6wp/neems.jpeg?updatedAt=1700153301777'} className="flex items-center gap-[12px] w-[36px] h-[36px] rounded-[28px] bg-lightgray bg-cover bg-no-repeat" />
        ...
        <div className=" container mx-auto flex justify-center py-8">
          <div className="flex flex-col items-start gap-[20px]">
            <div className="flex items-start gap-[20px]">
              ...
              <Link to="/postForBlog">
              <div className="flex w-[392px] p-[16px] flex-col justify-center	item-center gap-[16px] rounded-[12px] bg-white border-solid border-[1px] border-[#E8E8EA]">
                <img src={'https://ik.imagekit.io/9tezgt6wp/blog3.jpeg?updatedAt=1700153012522'} className="w-[360px] h-[240pxpx] rounded-[6px]" />
                <div className="flex p-[8px] flex-col items-start gap-[20px] self-stretch	">
                  <div className="flex flex-col items-start gap-[16px] self-stretch">
                    <button className="rounded-[16px] text-[#4B6BFB] bg-arbitrary  py-[4px] px-[10px] justify-center items-center gap-[4px] " style={{backgroundColor: 'rgba(75, 107, 251, 0.05)'}}>
                      Technology
              ...
              <Link to="/postForBlog">
              <div className="flex w-[392px] p-[16px] flex-col justify-center	item-center gap-[16px] rounded-[12px] bg-white border-solid border-[1px] border-[#E8E8EA]">
                <img src={'https://ik.imagekit.io/9tezgt6wp/blog4.jpeg?updatedAt=1700153052134'} className="w-[360px] h-[240pxpx] rounded-[6px]"/>
                <div className="flex p-[8px] flex-col items-start gap-[20px] self-stretch	">
                  <div className="flex flex-col items-start gap-[16px] self-stretch">
                    <button className="rounded-[16px] text-[#4B6BFB] bg-arbitrary  py-[4px] px-[10px] justify-center items-center gap-[4px] " style={{backgroundColor: 'rgba(75, 107, 251, 0.05)'}}>
                      Business
