      ...
      <div>
        ...
        <div className='w-80 h-100 shadow-lg rounded-md relative overflow-hidden p-4 '>
          ...
          <div className="pt-4">
            ...
            <p className="text-[#7B809A] text-sm">Last Campaign Performance</p>
        ...
        <div className='w-80 h-90 shadow-lg rounded-md relative overflow-hidden p-4 '>
          ...
          <p className="text-[#7B809A] text-sm">(+15%) increase in today investment.</p>
          <hr className="border-b border-gray-200 my-4"/>
          <div className="flex">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6"><path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 000-1.5h-3.75V6z" clipRule="evenodd" /></svg>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-28 mt-20 text-center block mx-auto h-40">
            <path fillRule="evenodd" d="M11.47 2.47a.75.75 0 011.06 0l4.5 4.5a.75.75 0 01-1.06 1.06l-3.22-3.22V16.5a.75.75 0 01-1.5 0V4.81L8.03 8.03a.75.75 0 01-1.06-1.06l4.5-4.5zM3 15.75a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z" clipRule="evenodd" /></svg>
          <div className="pt-4">
          <div className="flex justify-center align-center">
            </div>
            <h1 className="text-center mb-4 font-bold text-[#344767]">Upload Bank Transaction</h1>
            <p className="text-center font-bold mb-4 text-[#344767]"> Supporting Documents</p>
            <span className="text-[#7B809A] text-sm mb-8 pb-10 text-center mx-auto">Max 5mb</span>
