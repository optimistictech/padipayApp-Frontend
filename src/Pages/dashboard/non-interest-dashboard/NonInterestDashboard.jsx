...
import AdminSideNav from '../../../Components/Auth/Dashboard/side-navbar/NonInterestSidebar';
import AdminNavbar from '../../../Components/Auth/Dashboard/header-navbar/NonInterestNavbar';
      ...
      <div>
        ...
        <div className='flex justify-between pl-5 pt-5 pb-4 pr-8'>
          <div className='py-2'>
            ...
            <h6 className='pb-8 pt-2 text-gray-400 text-xs'>
              Submitted for listing (3)
            </h6>
            {/* TABLE */}
            <TableOne />
          </div>
