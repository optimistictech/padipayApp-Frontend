    ...
    <div>
      ...
      <div className="hero-section flex gap-16 px-10 py-5">
        <div className="hero-text">
          <h1 className="text-primary text-5xl font-bold mt-20 mb-5">About Us</h1>
          <div className="mb-5 text-xl text-justify">
            <p className='text-xl'>
              At <span className="font-bold ">PadiPay,</span> we're dedicated to
              revolutionizing the world of financial services through
              innovation, accessibility, and customer-centricity. We understand
              that financial transactions are at the heart of people's lives,
              and our mission is to simplify and enhance these experiences for
      ...
      <section className="text-section">
        <div className="px-20 my-16 w-3/5 mx-auto">
          <h3 className="font-bold text-center text-5xl text-primary">Our Vision</h3>
          <p className="text-justify text-xl my-6">
            ...
            financial well-being for all. We aspire to be the trusted partner in
            the financial journey of our customers, enabling them to achieve
        ...
        <div className="mb-5 px-10 py-5 flex gap-16">
          ...
          <div className="what-text text-justify">
            ...
            <ul className="list-decimal px-5 py-6 text-lg">
              <li>
                Innovation: By harnessing the power of
                technology, we create user-friendly and efficient solutions that
                keep our customers ahead in a rapidly evolving financial
                landscape.
              </li>
              <li>
                Accessibility: We believe in financial inclusion for all. Our
                products and services are  accessible to
                individuals and businesses of all sizes, regardless of their
                financial background or location.
              </li>
              <li>
                Security: Security is at the core of everything we do. We employ
                state-of-the-art security measures to protect our customers'
                data and transactions. Your trust is our top priority.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="flex flex-col items-start my-16 py-6 px-20 w-3/5 mx-auto">
        <div className="text-center">
          <h3 className="font-bold text-center text-5xl text-primary">
            Join Us on the <br />Financial Journey
          </h3>
          <p className="text-justify text-xl my-6">
            ...
            where innovation meets accessibility, and your financial goals are
            within reach.
          </p>
        </div>
