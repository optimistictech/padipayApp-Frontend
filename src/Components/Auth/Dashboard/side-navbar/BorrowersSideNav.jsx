...
const BorrowersSideNav = ({ user, loading }) => {
  ...
  const handleLinkClick = () => {
    setAccountType(accountType === 'lender' ? 'switch' : 'lender');
  };
    ...
    <div className=' w-[28%] text-white bg-[#003399] font-primaryFont p-5'>
      ...
      >
        ...
        <Select
          ...
          style={{ display: 'none' }}
        >
          <MenuItem value='lender'>Alfred Jimoh</MenuItem>
          <MenuItem value='switch'>Switch to a Lender</MenuItem>
        </Select>
      ...
      {/* lend */}
      <Link to='/kyc' className='flex gap-4 items-center px-3 py-5 '>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          fill='none'
          viewBox='0 0 24 24'
