...
const rows = [
  ...
  createData('Automobile', 'E', 356, 16.0, 49, 0, '5 months ago', 'pending'),
  createData('Student Loans', 'A', 356, 16.0, 49, 0, '3 months ago', 'active'),
  createData('Business', 'E', 356, 16.0, 49, 0, '6 months ago', 'pending'),
];
      ...
      <Table sx={{ minWidth: 700 }} aria-label='customized table'>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align='right'>Total Returns</StyledTableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.name}>
              ...
              <StyledTableCell align='right'>{row.terms}</StyledTableCell>
